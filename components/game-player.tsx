...
export function GamePlayer({ game }: { game: Game }) {
  ...
  useEffect(() => {
    /* eslint-disable react-hooks/set-state-in-effect -- el nivel se deriva del score acumulado, que solo existe en el cliente; leerlo aquí reproduce el conteo del prototipo sin tocar la hidratación */
