...
export type CatFilter = "TODOS" | Cat;
...
export const CATS: readonly Cat[] = ["ARCADE", "PUZZLE", "SHOOTER", "VERSUS"];
...
// Agrupación de miles con punto, sin Intl: idéntica en Node y en el navegador.
// Reproduce es-ES, que no agrupa por debajo de 5 dígitos (7820 -> "7820").
